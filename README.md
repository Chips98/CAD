...
本项目通过多个AI智能体（Agent）模拟真实的人际互动环境，支持用户自定义场景与事件。自由组合学业压力、职场竞争，或是家庭矛盾等因素，深度模拟不同人群在各类复杂情境下抑郁症产生的完整过程。模拟结束后，可与具备 30 天记忆回溯功能的虚拟角色开展心理咨询对话，为心理健康研究、心理咨询教学与科普体验，提供高度真实、可定制化的沉浸式交互场景。
